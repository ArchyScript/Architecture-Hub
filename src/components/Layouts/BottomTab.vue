      ...
      >
        ...
        >
          <router-link :to="bottom_bar_link.route">
            ...
            <span
              class="p-2 sm:p-3 text-ar chyhub-main flex flex-1 items-center justify-center"
            >
              <svg
                v-if="(bottom_bar_link.title === 'Home')"
              ...
              <svg
                v-if="(bottom_bar_link.title === 'Users')"
                class="h-4 sm:h-5 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512"
              >
              ...
              <svg
                v-if="(bottom_bar_link.title === 'Competitions')"
                class="h-4 sm:h-5 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 576 512"
              >
              ...
              <svg
                v-if="(bottom_bar_link.title === 'Scholarships')"
                class="h-4 sm:h-5 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 384 512"
              >
              ...
              <svg
                v-if="(bottom_bar_link.title === 'Profile')"
                class="h-4 sm:h-5 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
